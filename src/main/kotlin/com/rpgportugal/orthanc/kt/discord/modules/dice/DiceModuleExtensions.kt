        ...
        is TargetPoolDice -> {
            ...
            this.results.map {
                when(targetPoolExpr.comparison){
                    Comparison.GREATER_THAN -> if(it.value >= targetPoolExpr.target){"**${it.prettyPrint()}**"}else{it.prettyPrint()}
                    Comparison.LESS_THAN -> if(it.value <= targetPoolExpr.target){"**${it.prettyPrint()}**"}else{it.prettyPrint()}
                    Comparison.EQUAL_TO -> if(it.value == targetPoolExpr.target){"**${it.prettyPrint()}**"}else{it.prettyPrint()}
                }
